...
export function EditTaskModal({ onClose, isVisible, categories, taskToEdit, viewingUserId }) {
  ...
  useEffect(() => {
    if (taskToEdit) {
      ...
      setIsDaily(taskToEdit.isDaily !== undefined ? taskToEdit.isDaily : true);
  ...
  return (
    <ModalWrapper onClose={onClose} isVisible={isVisible} title="Editar Tarefa" size="md">
